...
#define DAME_SPHERE_BULLET 20
#define DAME_LASER_BULLET 30
#define DAME_THREAT_BULLET 15
#define DAME_THREAT_MOVE_BULLET 10
#define DAME_BOSS_BULLET 40
